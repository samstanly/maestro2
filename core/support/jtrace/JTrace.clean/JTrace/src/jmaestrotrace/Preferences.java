...
public class Preferences {
	...
	private static final String FILE_STRING = "preferences.txt";
	...
	public void setChoiceTabs(String[] tabs) {
		String result = "";
		try {
			FileWriter fstream = new FileWriter(FILE_STRING, false);
	...
	public void newCustom(String custom) {
		try {
			FileWriter fstream = new FileWriter(FILE_STRING, true);
